const EngineUI = {
  ...
  finish() {
    setTimeout(() => {
      ...
      // const main = document.getElementById("main-content"); // 메인 콘텐츠를 직접 표시하지 않음
      if (overlay) overlay.classList.add("opacity-0", "pointer-events-none");
      // 로딩 완료 후 Start Screen을 표시
      if (typeof window.showStartScreen === "function") {
        window.showStartScreen();
      }
      // document.body.classList.remove("overflow-hidden"); // start.js에서 처리
    }, 1000);
  },
};
